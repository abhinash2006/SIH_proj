...
print("\n--- 4. INSPECTION TARGETS (Directive 5 & Task 3) ---")
...
print(rescue_cards_md[:800] + ("..." if len(rescue_cards_md) > 800 else ""))

print("\n--- 7. 3D QUALITY METRICS ---")
print(quality_metrics_md)

# Save annotated frames to disk for visual proof
...
print(f"\nAnnotated inspection frames saved to: {annotated_out_dir}")
